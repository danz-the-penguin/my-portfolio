...
function FloatingDefinitionTooltip({ hoveredPlay, lookupWord }) {
...
export default function ScrabbleSolverV3() {
  ...
  const { candidatePlays, isSolving, checkWord, wordCheckResult } =
    useSolverWorker(
      deferredRack,
      deferredBoard,
      activePreset,
  ...
  }, [board, selectedCell, inputMode, tileOwners]);
          ...
          <div className="win98-titlebar">
            ...
            <div>
              <button
                ...
                onClick={() => (window.location.href = "localhost:4500")}
              >
                X
              </button>
            </div>
            ...
            >
              ...
              <div style={{ display: "flex", gap: "8px" }}>
                ...
                <div
                  style={{
                    width: "1px",
                    backgroundColor: "var(--w98-border-dark)",
                    margin: "0 4px",
                  }}
                />
                <button
